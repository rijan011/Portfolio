...
function initPDFDownloads() {
    ...
    if (pdfResourcesItem) {
        ...
        pdfResourcesItem.addEventListener('click', (e) => {
            ...
            if (e.target.classList.contains('pdf-btn') || e.target.closest('.pdf-btn')) {
                return;
            }
            showPDFModal();
        });
        ...
        // Animate PDF boxes
        const pdfBoxes = pdfResourcesItem.querySelectorAll('.pdf-box');
        ...
        <div class="pdf-modal-content">
            ...
            <div class="pdf-modal-body">
                <div class="pdf-modal-item">
                    ...
                    <h4>Mount Package</h4>
                    <a href="Mount Everest Package copy.pdf" class="pdf-btn">
                ...
                <div class="pdf-modal-item">
                    ...
                    <h4>God Package</h4>
                    <a href="Untitle.pdf" class="pdf-btn">
                        <i class="fas fa-eye"></i>
                        View PDF
                    </a>
                </div>
                <div class="pdf-modal-item">
                    ...
                    <h4>Room Package</h4>
                    <a href="Untitled copy.pdf" class="pdf-btn">
                        <i class="fas fa-eye"></i>
                        View PDF
                    </a>
                </div>
...
function initTheme() {
    ...
    if (metaThemeColor) {
        metaThemeColor.content = savedTheme === 'dark' ? '#0f0f23' : '#f0f4ff';
    }
}
...
function toggleTheme() {
    ...
    const metaThemeColor = document.querySelector('meta[name="theme-color"]');
    if (metaThemeColor) {
        metaThemeColor.content = newTheme === 'dark' ? '#0f0f23' : '#f0f4ff';
    }
}
...
// Mobile Navigation Toggle - Enhanced with Touch Support
...
navLinks.forEach(link => {
    ...
    link.addEventListener('touchstart', (e) => {
        e.preventDefault();
        link.style.backgroundColor = 'rgba(129, 140, 248, 0.1)';
    });
...
document.addEventListener('touchend', (e) => {
    ...
    if (swipeDistance > 50 && Math.abs(touchStartX - touchEndX) > 50) {
...
function handleResponsiveAdjustments() {
    ...
    if (particlesContainer) {
        ...
        const targetParticles = isMobile ? 10 : isTablet ? 25 : 50;
        
        if (currentParticles < targetParticles) {
            for (let i = currentParticles; i < targetParticles; i++) {
                createParticle();
            }
        } else if (currentParticles > targetParticles) {
            for (let i = currentParticles; i > targetParticles; i--) {
...
navLinks.forEach(link => {
    link.addEventListener('click', (e) => {
        ...
        // Only handle smooth scrolling for internal anchor links (starting with #)
        ...
        // Allow default behavior for external page links (.html files)
    });
});

// Work Filter Functionality - Optimized
        ...
        requestAnimationFrame(() => {
            workItems.forEach((item, index) => {
                ...
                if (filter === 'all' || category === filter) {
                    ...
                    // Use staggered animation for better performance
                    setTimeout(() => {
...
// Mouse Move Effect for Hero Image - Optimized
...
if (heroImage) {
    ...
    function updateHeroImage() {
        ...
        const xPos = (mouseX - innerWidth / 2) / innerWidth;
        const yPos = (mouseY - innerHeight / 2) / innerHeight;
        
        // Smooth interpolation
        currentX += (xPos * 20 - currentX) * 0.1;
        currentY += (yPos * 20 - currentY) * 0.1;
...
if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
        ...
        if (!name || name.length < 2) {
            showNotification('Please enter your name (min 2 characters)', 'error');
            return;
        }
...
// Apply throttle to mouse move events for cursor trail
...
function initSmoothScroll() {
    ...
    document.querySelectorAll('a[href$=".html"]').forEach(link => {
        link.addEventListener('click', function(e) {
            // Allow normal navigation for external HTML pages
            // No preventDefault() - let them navigate normally
        });
    });
}
